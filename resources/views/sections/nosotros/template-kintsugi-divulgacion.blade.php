    ...
    <div class="container mx-auto px-4 py-12 lg:py-28 relative z-10">
      <div class="flex flex-col lg:flex-row items-center">
        ...
        <div class="lg:w-1/2 flex justify-center lg:justify-end relative" data-aos="fade-left" data-aos-duration="600">
          <!-- Fondo morado orgánico que rodea la imagen con medidas precisas - Responsive en mobile pero no afecta desktop -->
          <div class="absolute inset-0 z-0 transition-transform duration-700 hover:scale-105">
            <svg width="586.48px" height="565.73px" viewBox="0 0 586.48 565.73" fill="none" xmlns="http://www.w3.org/2000/svg" 
                 style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; transform-origin: center;">
          ...
          <!-- Imagen actual con tamaño reducido en mobile -->
          <img 
  ...
  <section class="bg-[#CCA0E00D] py-8 lg:py-16">
    <div class="container mx-auto px-4">
      ...
      <div class="max-w-4xl mx-auto text-center" data-aos="fade-up" data-aos-duration="600">
        ...
        <div class="mt-16 mb-8" data-aos="fade-up" data-aos-duration="600" data-aos-delay="100">
          <h3 class="text-xl md:text-2xl font-bold text-[#030D55] mb-4 md:mb-6 transition-all duration-500 hover:text-[#AB277A] font-paytone">
