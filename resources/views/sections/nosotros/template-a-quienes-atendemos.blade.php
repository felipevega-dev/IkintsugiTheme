  ...
  <section class="bg-white py-16">
    <div class="container mx-auto px-4">
      ...
      <div class="max-w-6xl mx-auto">
        <!-- Adolescentes -->
        <div class="flex flex-col md:flex-row items-center justify-between mb-32">
          <div class="md:w-1/2 pr-10 self-center">
          ...
          <div class="md:w-1/2 relative mt-10 md:mt-0 self-center">
        ...
        <!-- Adultos -->
        <div class="flex flex-col md:flex-row-reverse items-center justify-between mb-32">
          <div class="md:w-1/2 pl-10 self-center">
            <h2 class="text-2xl font-bold text-[#AB277A] mb-6" style="font-family: 'Playfair Display', serif;">
              Adultos
          </h2>
            <p class="text-base text-[#030D55]">
