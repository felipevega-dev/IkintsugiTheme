    ...
    <div class="container mx-auto px-4 py-12 lg:py-28 relative z-10">
      <div class="flex flex-col lg:flex-row items-center">
        ...
        <div class="lg:w-1/2 mb-8 lg:mb-12" data-aos="fade-right" data-aos-duration="600">
          <span class="text-[#AB277A] text-sm md:text-base uppercase tracking-wider font-medium mb-2 block">Qué nos inspira</span>
          ...
          Sanar es renacer con más fuerza 
          </h1>
        ...
        <div class="lg:w-1/2 flex justify-center lg:justify-end relative" data-aos="fade-left" data-aos-duration="600">
          ...
          <div class="absolute inset-0 z-0 transition-transform duration-700 hover:scale-105">
            <svg width="586.48px" height="565.73px" viewBox="0 0 586.48 565.73" fill="none" xmlns="http://www.w3.org/2000/svg" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; transform-origin: center;">
          ...
          <div class="absolute w-12 h-12 md:w-16 md:h-16 rounded-full bg-[#9978d1] opacity-40 top-8 md:top-10 left-4 md:left-5 z-0 animate-pulse"></div>
          <div class="absolute w-8 h-8 md:w-12 md:h-12 rounded-full bg-[#9978d1] opacity-30 bottom-8 md:bottom-10 right-8 md:right-10 z-0 animate-pulse" style="animation-delay: 1s;"></div>
          <!-- Líneas decorativas -->
          ...
          <img 
            ...
            class="max-w-full h-auto rounded-lg relative z-10 transition-transform duration-500 hover:scale-105 w-[85%] sm:w-[90%] md:w-[95%] lg:w-auto"
  ...
  <section class="bg-[#CCA0E00D] py-8 lg:py-16 overflow-x-hidden">
    <div class="container mx-auto px-4">
      <div class="flex flex-col lg:flex-row items-center gap-6 md:gap-8">
        ...
        <div class="lg:w-1/2 flex justify-center lg:justify-start relative order-2 lg:order-1 mb-6 md:mb-0" data-aos="fade-right" data-aos-duration="600">
          <img 
        ...
        <!-- Texto explicativo -->
        <div class="lg:w-1/2 mb-6 lg:mb-0 pr-0 lg:pr-6 order-1 lg:order-2" data-aos="fade-left" data-aos-duration="600">
