  ...
  <div class="container mx-auto px-4 relative z-10">
    <div class="flex flex-col md:flex-row items-center gap-8 md:gap-12">
      <div class="w-full md:w-1/2 mb-8 md:mb-0" data-aos="fade-up" data-aos-duration="1000">
        ...
        <p class="text-[#5A0989] font-roboto font-medium text-lg md:text-2xl mb-6 md:mb-8" data-aos="fade-up" data-aos-duration="800" data-aos-delay="100">LUN-VIE: 10:00 – 12:00 / 15:00 –20:00 HRS.</p>
        <a href="/reservar-cita" class="inline-block bg-gradient-to-r from-[#FF3382] to-[#5A0989] text-white px-6 md:px-8 py-2 md:py-3 rounded-full font-roboto font-semibold text-lg md:text-xl transition-all duration-300 hover:shadow-lg hover:scale-105 service-button" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
          Reservar Cita
        </a>
      </div>
