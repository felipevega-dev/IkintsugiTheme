...
<section class="py-10 bg-white relative">
  <div class="container mx-auto px-4 pt-10">
    ...
    <div class="flex flex-wrap justify-center gap-10 md:gap-[50px] max-w-6xl mx-auto">
      <!-- Testimonio 1 -->
      <div class="relative p-[24px] w-full md:w-[525px] h-auto md:h-[398px] rounded-[16px] border border-[#D9D9D9] mb-20 md:mb-0" style="background: linear-gradient(180deg, rgba(3, 13, 85, 0.15) 0%, rgba(171, 39, 122, 0.15) 100%);">
        <!-- Profile image -->
        <div class="absolute w-[160px] h-[160px] md:w-[290px] md:h-[290px] top-[-80px] md:top-[-114px] left-1/2 -translate-x-1/2 md:left-[117.5px] md:translate-x-0">
