...
<section class="py-10 bg-white relative">
  <div class="container mx-auto px-4 pt-10">
    <!-- Section title -->
    <h2 class="text-[#030D55] font-extrabold text-3xl md:text-5xl md:text-[48px] leading-tight mb-32 md:mb-56 text-center" style="font-family: 'Playfair Display', serif;">
      Nuestros testimonios
    </h2>
    
    <!-- Testimonials Grid -->
    <div class="flex flex-wrap justify-center gap-20 md:gap-[50px] max-w-6xl mx-auto">
      <!-- Testimonio 1 -->
      <div class="relative p-[24px] w-full md:w-[525px] h-auto md:h-[398px] rounded-[16px] border border-[#D9D9D9] mb-12 md:mb-0" style="background: linear-gradient(180deg, rgba(3, 13, 85, 0.15) 0%, rgba(171, 39, 122, 0.15) 100%);">
        <!-- Profile image -->
        <div class="absolute w-[200px] h-[200px] md:w-[290px] md:h-[290px] top-[-100px] md:top-[-114px] left-1/2 -translate-x-1/2 md:left-[117.5px] md:translate-x-0">
        ...
        <!-- Name -->
        <h3 class="text-[#AB277A] font-extrabold text-[20px] md:text-[24px] text-center mt-[120px] md:mt-[180px] mb-4" style="font-family: 'Playfair Display', serif;">Lorena López</h3>
      ...
      <!-- Testimonio 2 -->
      <div class="relative p-[24px] w-full md:w-[525px] h-auto md:h-[398px] rounded-[16px] border border-[#D9D9D9]" style="background: linear-gradient(180deg, rgba(3, 13, 85, 0.15) 0%, rgba(171, 39, 122, 0.15) 100%);">
        <!-- Profile image -->
        <div class="absolute w-[200px] h-[200px] md:w-[290px] md:h-[290px] top-[-100px] md:top-[-114px] left-1/2 -translate-x-1/2 md:left-[117.5px] md:translate-x-0">
          <div class="w-full h-full rounded-full overflow-hidden border-[8px] border-white">
        ...
        <!-- Name -->
        <h3 class="text-[#AB277A] font-extrabold text-[20px] md:text-[24px] text-center mt-[120px] md:mt-[180px] mb-4" style="font-family: 'Playfair Display', serif;">Fernando Torres</h3>
