...
<section class="py-16 bg-white relative">
  <div class="container mx-auto px-4 relative">
    ...
    <div class="relative max-w-[650px] mx-auto">
      ...
      <div class="absolute -left-32 top-1/2 transform -translate-y-1/2 hidden md:block">
        <img src="{{ get_theme_file_uri('resources/images/deco1.png') }}" alt="Decorative Element" class="w-32">
      </div>
      
      <!-- Decorative image right -->
      <div class="absolute -right-32 top-1/2 transform -translate-y-1/2 hidden md:block">
        <img src="{{ get_theme_file_uri('resources/images/deco2.png') }}" alt="Decorative Element" class="w-32">
      </div>
      ...
      <div class="space-y-6">
        ...
        <div class="faq-item border border-gray-200 rounded-md overflow-hidden w-full" style="max-width: 625px;">
          ...
          <div class="faq-answer hidden bg-[#FFF3FF8F] p-4 transition-all duration-500 ease-in-out" style="max-height: 0; overflow: hidden;">
