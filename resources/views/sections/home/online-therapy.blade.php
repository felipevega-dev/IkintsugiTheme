...
<section class="pt-0 pb-16 bg-white relative mt-[-50px] z-20">
    ...
    <div class="flex flex-col md:flex-row items-center gap-12 mt-16">
      ...
      <div class="md:w-1/2">
        <div class="relative">
          ...
          <div class="relative overflow-hidden" style="border-radius: 30% 70% 70% 30% / 30% 30% 70% 70%; width: 100%; aspect-ratio: 1/1;">
            <!-- Imagen principal -->
      ...
      <div class="md:w-1/2">
        <div class="p-6 rounded-lg">
          <h2 class="text-[#030D55] font-extrabold text-5xl leading-tight mb-6 max-w-[600px]" style="font-family: 'Playfair Display', serif;">
            Obtenga terapia experta hoy para el futuro
          </h2>
          <p class="text-gray-700 font-roboto mb-6 text-[#181818]">
          ...
          <a href="/reservar-cita" class="inline-block bg-gradient-to-r from-[#FF3382] to-[#5A0989] text-white px-8 py-2 rounded-full font-roboto font-semibold text-xl transition-all duration-300 hover:shadow-lg">
            Reservar Cita
          </a>
        </div>
      </div>
