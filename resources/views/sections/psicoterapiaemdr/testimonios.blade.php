    ...
    <div class="container mx-auto px-4 py-20 lg:py-28 relative z-10 mt-15">
      <div class="flex flex-col lg:flex-row items-center">
        ...
        <div class="lg:w-1/2 mb-12 lg:mb-0" data-aos="fade-right" data-aos-duration="600">
          <h1 class="text-5xl lg:text-7xl font-bold text-[#030D55] mb-8 leading-none transition-all duration-500 hover:text-[#AB277A]" style="font-family: 'Playfair Display', serif; font-weight: 800;">
            Testimonios que inspiran: La sanación es posible
          </h1>
          <p class="text-3xl lg:text-5xl text-[#AB277A] mt-6 transition-all duration-300 hover:translate-x-2" style="font-family: 'Hugamour', serif; font-weight: 400;">
