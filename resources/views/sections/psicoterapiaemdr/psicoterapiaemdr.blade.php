  ...
  <section class="relative bg-white pt-20 md:pt-36 pb-10 md:pb-15 overflow-hidden">
    <div class="container mx-auto px-4 relative z-10">
      ...
      <div class="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
        ...
        <div class="w-full md:w-3/5 md:order-first md:ml-auto">
  ...
  <section class="bg-[#CCA0E00D] py-10 lg:py-16">
    <div class="container mx-auto px-4">
      <div class="flex flex-col lg:flex-row items-center gap-8">
        ...
        <div class="w-full lg:w-1/2 flex justify-center lg:justify-start relative order-2 lg:order-1">
        ...
        <!-- Texto explicativo -->
        <div class="w-full lg:w-1/2 mb-8 lg:mb-0 pr-0 lg:pr-6 order-1 lg:order-2">
          <h2 class="text-center lg:text-left text-3xl md:text-4xl lg:text-5xl font-bold text-[#030D55] mb-6 md:mb-8" style="font-family: 'Playfair Display', serif; font-weight: 800;">
  ...
  <section class="bg-white py-10 lg:py-16 max-w-[1440px] mx-auto">
    <div class="container mx-auto px-4">
      <div class="flex flex-col lg:flex-row items-center gap-6 md:gap-4">
        <!-- Texto explicativo -->
        <div class="w-full lg:w-1/2 mb-8 lg:mb-0 pr-0 lg:pr-6 order-1">
          <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold text-[#030D55] mb-6 md:mb-8" style="font-family: 'Playfair Display', serif;">
          ...
          <div class="prose prose-lg">
            ...
            <div class="mt-8">
              <img src="{{ get_theme_file_uri('resources/images/emdrlogo.png') }}" alt="EMDR Logo" class="w-[180px] md:w-[222px] h-auto md:h-[52px]">
        ...
        <div class="w-full lg:w-1/2 flex justify-center lg:justify-end relative order-2">
          <img 
