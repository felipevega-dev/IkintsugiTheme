...
<section class="relative bg-[#362766] overflow-hidden pt-24 md:pt-32">
  ...
  <div class="absolute inset-0 z-0">
    ...
    <img 
      ...
      class="absolute inset-0 w-full h-full object-cover object-[center_05%]" 
    >
  </div>
        
  <!-- Contenido del hero -->
  <div class="container mx-auto px-4 relative z-10 min-h-[500px] md:min-h-[80vh] flex flex-col justify-center items-center">
    <div class="max-w-4xl mx-auto text-center text-white py-20 md:py-32">
      <h1 class="text-5xl md:text-6xl lg:text-7xl font-bold mb-8 font-paytone" data-aos="fade-up" data-aos-duration="1200">Conéctate con nosotros donde quieras</h1>
      <p class="text-xl md:text-2xl font-roboto mb-8" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">Encuentra contenido exclusivo, episodios de nuestro podcast, videos, reflexiones y más en nuestras plataformas. ¡Acompáñanos en este camino de bienestar y transformación!</p>
    </div>
  </div>
...
<section class="bg-white py-16 md:py-24 overflow-hidden">
  <div class="container mx-auto px-4">
    <h2 class="text-4xl font-bold text-[#030D55] mb-16 text-center font-paytone" data-aos="fade-up" data-aos-duration="1000">
    ...
    <div class="flex flex-col md:flex-row items-center justify-between gap-12 mb-24">
      <div class="md:w-1/2" data-aos="fade-right" data-aos-duration="1000">
        <div class="flex items-center gap-4 mb-6">
          <svg class="w-8 h-8 text-[#FF0000]" fill="currentColor" viewBox="0 0 24 24">
            <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"/>
          </svg>
          <h3 class="text-2xl font-bold text-[#D93280] font-paytone">Canal de YouTube</h3>
        </div>
        <p class="text-lg text-[#030D55] mb-6 font-roboto">
          Descubre contenido valioso sobre salud mental, desarrollo personal y bienestar emocional. Nuestros videos te ayudarán a:
        </p>
        <ul class="space-y-3 text-[#030D55] font-roboto">
          <li class="flex items-center gap-2">
            <svg class="w-5 h-5 text-[#D93280]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <li class="flex items-center gap-2">
            ...
            Desarrollar herramientas para el manejo del estrés
          </li>
          <li class="flex items-center gap-2">
            <svg class="w-5 h-5 text-[#D93280]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
        ...
        <a href="https://www.youtube.com/@emisorkintsugi" target="_blank" class="inline-flex items-center gap-2 bg-[#D93280] text-white px-6 py-3 rounded-full mt-8 transition-transform hover:scale-105 font-roboto">
    ...
    <div class="flex flex-col-reverse md:flex-row items-center justify-between gap-12">
      <div class="md:w-1/2" data-aos="fade-right" data-aos-duration="1000">
        <div class="relative w-full rounded-2xl overflow-hidden shadow-xl" style="min-height: 400px;">
          <iframe 
      ...
      <div class="md:w-1/2" data-aos="fade-left" data-aos-duration="1000">
        <div class="flex items-center gap-4 mb-6">
          <svg class="w-8 h-8 text-[#1DB954]" fill="currentColor" viewBox="0 0 24 24">
            <path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.66 0 12 0zm5.521 17.34c-.24.359-.66.48-1.021.24-2.82-1.74-6.36-2.101-10.561-1.141-.418.122-.779-.179-.899-.539-.12-.421.18-.78.54-.9 4.56-1.021 8.52-.6 11.64 1.32.42.18.479.659.301 1.02zm1.44-3.3c-.301.42-.841.6-1.262.3-3.239-1.98-8.159-2.58-11.939-1.38-.479.12-1.02-.12-1.14-.6-.12-.48.12-1.021.6-1.141C9.6 9.9 15 10.561 18.72 12.84c.361.181.54.78.241 1.2zm.12-3.36C15.24 8.4 8.82 8.16 5.16 9.301c-.6.179-1.2-.181-1.38-.721-.18-.601.18-1.2.72-1.381 4.26-1.26 11.28-1.02 15.721 1.621.539.3.719 1.02.419 1.56-.299.421-1.02.599-1.559.3z"/>
          </svg>
          <h3 class="text-2xl font-bold text-[#D93280] font-paytone">Podcast en Spotify</h3>
        </div>
        <p class="text-lg text-[#030D55] mb-6 font-roboto">
        ...
        <ul class="space-y-3 text-[#030D55] font-roboto">
          <li class="flex items-center gap-2">
            ...
            Conversaciones profundas sobre salud mental
          </li>
          <li class="flex items-center gap-2">
            <svg class="w-5 h-5 text-[#D93280]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
        ...
        <a href="https://open.spotify.com/show/08J06mjqK1UxNgXPTVlMkJ" target="_blank" class="inline-flex items-center gap-2 bg-[#D93280] text-white px-6 py-3 rounded-full mt-8 transition-transform hover:scale-105 font-roboto">
...
<section class="bg-gray-50 py-16 md:py-24 relative">
  <div class="container mx-auto px-4">
    <h2 class="text-4xl font-bold text-[#030D55] mb-16 text-center font-paytone" data-aos="fade-up" data-aos-duration="1000">
    ...
    <div class="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
      ...
      <div class="bg-white rounded-2xl p-8 shadow-lg transform transition-all duration-300 hover:-translate-y-2" data-aos="fade-up" data-aos-duration="800">
        <div class="flex items-center gap-8">
          ...
          <div class="flex flex-col gap-6">
            <div>
              <h3 class="text-2xl font-bold text-[#030D55] font-paytone">Julio César</h3>
      ...
      <!-- Perfil de Shenhui -->
      <div class="bg-white rounded-2xl p-8 shadow-lg transform transition-all duration-300 hover:-translate-y-2" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
        <div class="flex items-center gap-8">
          <div class="w-32 h-32 flex-shrink-0">
          ...
          <div class="flex flex-col gap-6">
            <div>
              <h3 class="text-2xl font-bold text-[#030D55] font-paytone">Shenhui</h3>
