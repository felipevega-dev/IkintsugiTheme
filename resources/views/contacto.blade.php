            ...
            <div class="whatsapp-content py-4 bg-[#25D366]/10 rounded-xl p-4">
              ...
              <div class="space-y-3">
                ...
                <div class="flex items-center justify-between bg-white rounded-lg p-3 shadow-sm hover:shadow-md transition-all duration-300">
                  <div class="flex items-center">
                    <div class="w-16 h-16 overflow-hidden mr-3">
                      <img src="{{ get_theme_file_uri('resources/images/juliomini.png') }}" alt="Julio César" class="w-full h-full object-cover transition-all duration-500 hover:scale-110">
                    </div>
                    <div class="text-left">
                  ...
                  <a href="https://wa.me/56937166362" target="_blank" class="bg-[#25D366] p-2.5 rounded-full text-white hover:bg-[#20b956] transition-all duration-300 shadow-md hover:shadow-lg hover:scale-110">
                ...
                <div class="flex items-center justify-between bg-white rounded-lg p-3 shadow-sm hover:shadow-md transition-all duration-300">
                  <div class="flex items-center">
                    <div class="w-16 h-16 overflow-hidden mr-3">
                      <img src="{{ get_theme_file_uri('resources/images/shenmini.png') }}" alt="Shénhui Lin" class="w-full h-full object-cover transition-all duration-500 hover:scale-110">
                    </div>
                    <div class="text-left">
                  ...
                  <a href="https://wa.me/56956345078" target="_blank" class="bg-[#25D366] p-2.5 rounded-full text-white hover:bg-[#20b956] transition-all duration-300 shadow-md hover:shadow-lg hover:scale-110">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                      <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path>
                    </svg>
                  </a>
