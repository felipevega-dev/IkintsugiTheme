...
<style>
  ...
  <section class="relative bg-white overflow-hidden pt-8 md:pt-12">
    <!-- Contenido del hero -->
    <div class="container mx-auto px-4 py-20 lg:py-28 relative z-10">
      <div class="flex flex-col lg:flex-row items-center">
        ...
        <div class="lg:w-1/2 flex justify-center lg:justify-end relative mt-12 lg:mt-0" data-aos="fade-left" data-aos-duration="600">
...
<section class="bg-white relative mb-20">
  <div class="container mx-auto px-4 relative">
    <!-- Section title -->
    <h2 class="text-2xl md:text-4xl lg:text-5xl font-bold text-[#030D55] mb-8 md:mb-16 text-center font-paytone">
      FAQ's
    </h2>
